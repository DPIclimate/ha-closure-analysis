...
typedef struct {
    char id[BOM_STATION_ID_SIZE];
    char state[BOM_STATION_STATE_SIZE];
    char name[BOM_STATION_NAME_SIZE];
...
typedef struct {
    int16_t count;
    BOM_WeatherStation_TypeDef stations[BOM_STATION_MAX_RESPONSES];
